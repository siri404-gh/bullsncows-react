        ...
        <div className="form-group">
          <div className='row'>
            ...
            <div className='col-xs-9 col-sm-10 col-md-9'>
              <input type="text" id="usr" ref={node => input = node} type="text" maxLength={theWord.length} onKeyDown={populate} autoFocus className={'form-control ' + Styles.input} autoComplete="off" autocapitalize="none"/>
            </div>
